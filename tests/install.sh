...
AI_SKILLS_TARGET_DIR="$target_dir" "$installer" spec arch-design feature-implementation >/dev/null
...
AI_SKILLS_TARGET_DIR="$target_dir" "$installer" spec arch-design feature-implementation >/dev/null
AI_SKILLS_TARGET_DIR="$target_dir" "$installer" spec arch-design feature-implementation feature-implementation >/dev/null
...
expect_failure env AI_SKILLS_TARGET_DIR="$partial_target" "$installer" spec arch-design feature-implementation missing-skill
...
expect_failure env AI_SKILLS_TARGET_DIR="$batch_conflict_target" "$installer" spec arch-design feature-implementation
