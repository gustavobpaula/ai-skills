...
```sh
./scripts/install.sh spec arch-design feature-implementation requirements-review code-review delivery-check test-strategy arch-review simplify a11y-review
```
